...
## ALGORITHM:
Choose a large prime number p and an elliptic curve defined by the equation 𝑦^2 = 𝑥^3 + 𝑎𝑥 +𝑏 mod p along with a base point G on the curve. Alice and Bob choose private keys. Compute public keys: public_key = private_key * G (point multiplication). Exchange public keys. Compute the shared secret: shared_secret = private_key * public_key_received.
...
```
## OUTPUT
![image](https://github.com/user-attachments/assets/086b66ff-8282-4ca3-a0e4-168c0909d938)
## RESULT
